...
namespace vis {
	...
	class MinimumFilter : public Algorithm {
	public:
		...
		VISIONDLL_API MinimumFilter(unsigned int ratio);
		...
		// From there on it will execute the minimumfilter algorithm, and edit the actual data in image_dst
