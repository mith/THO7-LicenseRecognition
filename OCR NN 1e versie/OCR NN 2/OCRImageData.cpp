...
// Return topology
void OCRImageData::getTopology(std::vector<unsigned> &topology) {

	topology.push_back(18);//Input nodes
	topology.push_back(11);//Hidden nodes
	topology.push_back(6);//Uitput nodes
...
unsigned OCRImageData::getImageList() {
	...
	/*imageList.push_back(ImageGray("../Images/Origineel/a.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/b.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/c.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/d.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/e.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/f.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/g.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/h.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/i.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/j.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/k.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/l.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/m.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/n.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/o.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/p.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/q.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/r.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/s.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/t.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/u.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/v.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/w.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/x.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/y.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/z.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/0.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/1.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/2.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/3.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/4.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/5.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/6.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/7.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/8.jpg"));
	imageList.push_back(ImageGray("../Images/Origineel/9.jpg"));*/
