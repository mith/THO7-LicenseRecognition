...
public:
	...
	double checkPixelsPerLineHorizontal(ImageGray &sourceImage, int percentage);
	...
	double checkPixelsPerLineVertical(ImageGray &sourceImage, int percentage);

	// =======================================================================================

	// BlackWhiteTransition - Wouter Veen
	double checkBlackWhiteTransisitionVertical(ImageGray &sourceImage, int percentage);
	double checkBlackWhiteTransisitionHorizontal(ImageGray &sourceImage, int percentage);
	...
	double checkSymmetryHorizontal(ImageGray &sourceImage, bool boundingBox = 0);
	...
	// below.
	// This function returns a percentage.
	double checkSymmetryVertical(ImageGray &sourceImage, bool boundingBox = 0);
	...
	int findLeftBlackPixel(ImageGray &sourceImage);
	int findRightBlackPixel(ImageGray &sourceImage);
	int findTopBlackPixel(ImageGray &sourceImage);
	int findBottomBlackPixel(ImageGray &sourceImage);
};
