...
double CheckPatterns::checkPixelsPerLineHorizontal(ImageGray &sourceImage, int percentage)
{
	//bt->reset();
	//bt->start();
...
double CheckPatterns::checkPixelsPerLineVertical(ImageGray &sourceImage, int percentage)
{
	//bt->reset();
	//bt->start();
...
double CheckPatterns::checkBlackWhiteTransisitionHorizontal(ImageGray &sourceImage, int percentage)
{
	//bt->reset();
	//bt->start();
...
double CheckPatterns::checkBlackWhiteTransisitionVertical(ImageGray &sourceImage, int percentage)
{
	//bt->reset();
	//bt->start();
	int x = Extensions::getValueFromPercentage(sourceImage.width(), percentage);
...
double CheckPatterns::checkSymmetryHorizontal(ImageGray &sourceImage, bool boundingBox)
{
	//bt->reset();
	//bt->start();
...
double CheckPatterns::checkSymmetryVertical(ImageGray &sourceImage, bool boundingBox)
{
	//bt->reset();
	//bt->start();
	int numberOfBlackPixels = 0, symmetricBlackPixels = 0;
...
int CheckPatterns::findLeftBlackPixel(ImageGray &sourceImage)
{
...
int CheckPatterns::findRightBlackPixel(ImageGray &sourceImage)
{
	int xValue = 0;
	for (int y = sourceImage.height(); y >= 0; y--)
	{
...
int CheckPatterns::findTopBlackPixel(ImageGray &sourceImage)
{
...
int CheckPatterns::findBottomBlackPixel(ImageGray &sourceImage)
{
	int yValue = 0;
	for (int x = sourceImage.width(); x >= 0; x--)
	{
